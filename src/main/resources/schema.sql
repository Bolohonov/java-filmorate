...
ALTER TABLE film_mpa ADD CONSTRAINT IF NOT EXISTS film_id_to_film FOREIGN KEY (film_id)
    REFERENCES film ON DELETE CASCADE;
ALTER TABLE film_mpa ADD CONSTRAINT IF NOT EXISTS mpa_id_to_mpa FOREIGN KEY (mpa_id)
    REFERENCES mpa ON DELETE CASCADE;